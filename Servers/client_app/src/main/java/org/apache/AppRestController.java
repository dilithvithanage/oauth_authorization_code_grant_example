...
public class AppRestController {
    ...
    @RequestMapping(value = "/login-connectme", method=RequestMethod.GET)
    public RedirectView processForm1() {
        RedirectView redirectView = new RedirectView();
        redirectView.setUrl("http://localhost:9002/auth/oauth/authorize?response_type=code&client_id=5744895711&redirect_url=http://localhost:9003/oauth/access?key=value&scope=user_read%20user_write");
        return redirectView;
    }
    ...
    {
        String auth_url = "http://localhost:9002/auth/oauth/token";
        ...
        try
        {
            ...
            con.setRequestProperty("Authorization", "Basic NTc0NDg5NTcxMTpoanN1VWhnODk=");
    ...
    public String getResource(String accessToken)
    {
        try
        {
            String ResourceUrl = "http://localhost:9001/users";
